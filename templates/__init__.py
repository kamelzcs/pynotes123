...
def index (notes):
    ...
    extend_([u'    <script type="text/javascript" src="/static/js/datepicker.js"></script>\n'])
    ...
    extend_([u'<form id=form method="post" action="/note">\n'])
    extend_([u'<p>Year  \n'])
    extend_([u'<input name="year" size="1" id="year">\n'])
    extend_([u'</input> \n'])
    extend_([u'Month \n'])
    extend_([u'<input name="month" size="1" id="month">\n'])
    extend_([u'</input>\n'])
    extend_([u'\n'])
    extend_([u'Date \n'])
    extend_([u'<input name="day" size="1" id="day">\n'])
    extend_([u'</input> \n'])
    extend_([u'<button type="submit">submit</button>\n'])
    extend_([u'</p>\n'])
    extend_([u'<p>Date: <input type="text" id="datepicker"></p>\n'])
